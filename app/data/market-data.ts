...
export const marketSnapshot = {
  ...
  weeklyTokyo23: {
    weekLabel: "2026年8月24日〜8月30日",
    status: "成約価格の上昇と売出価格の小幅下落が併存",
    lead:
      "7月の東京23区成約㎡単価は前年比で上昇する一方、成約件数は減少しました。8月24日公表の70㎡売出価格は前月比で僅かに下落しています。CLOSE・INVENTORY・ASK・RENTを分けて確認します。",
    indicators: [
      {
        label: "23区 7月成約件数",
        value: "1,509件",
      ...
      },
      {
        label: "23区 70㎡売出価格",
        value: "1億2,724万円",
        change: "前年比 +21.4%／前月 −0.1%",
        direction: "down",
        kind: "ASK",
        period: "2026年7月・8/24公表",
        sample: "23区 n非公表／首都圏 n=39,421",
      },
      {
        label: "23区 募集賃料",
        value: "5,157円/㎡",
    ...
    movements: [
      {
        label: "価格",
        title: "成約単価は上昇、売出価格は僅かに下落",
        detail: "23区の7月成約㎡単価は前年比+2.7%、前月比+3.5%。一方、70㎡売出価格は前月比−0.1%で、CLOSEとASKの方向差があります。",
        tone: "caution",
      },
      {
        label: "流動性",
    ...
    interpretation:
      "成約単価は上昇していますが、件数減・在庫増に加え、70㎡売出価格は2カ月連続で下落しました。同一棟・近い面積の成約根拠を優先し、売出価格と成約価格を分けて判断するのが今週の要点です。",
  },
  priceTrend: {
  ...
  sources: [
    ...
    {
      label: "中古マンション70㎡売出価格 2026年7月",
      publisher: "東京カンテイ",
      url: "https://www.kantei.ne.jp/report/70m2/9297/",
      tier: "B",
      usage: "東京23区の売出価格・前年比・前月比（8月24日公表）",
    },
    {
